        ...
        <section className="container-fluid p-0 mb-5 pb-5 position-relative">
            ...
            <div className="bg-black text-white" style={{ height: '160px' }}>
                <div className="container h-100 d-flex align-items-center">
                    <h1 className="fw-bold ps-md-5" style={{ fontSize: 'calc(1.3rem + .8vw)' }}>
                        Case Studies
                    </h1>
                </div>
            </div>
                ...
                <div className="row justify-content-center">
                    <div className="col-12 col-lg-10 ps-md-5">
                        ...
                        >
                            ...
                            <Link 
                                href="/" 
                                className="btn fw-bold px-4 py-2 d-inline-flex align-items-center gap-2 border-0 hover-scale"
