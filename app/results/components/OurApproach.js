    ...
    return (
        <section className="container py-5">
            <div className="d-flex flex-column align-items-center gap-4">
                ...
                {/* Section Badge */}
                <h1 className="badge rounded-pill px-4 py-2 bg-black fw-bold" 
                    style={{ color: '#eef430', fontSize: '1.2rem', whiteSpace: 'normal' }}>
                    Our Approach To Integration
                </h1>

                {/* Main Title */}
                <h2 className="fw-semibold text-center mb-4" style={{ fontSize: 'calc(1.4rem + 1vw)' }}>
                            ...
                            {group.items.map((item, itemIdx) => (
                                <div key={itemIdx} className="col-12 col-md-6">
                                    <div className="h-100 p-4 shadow-sm d-flex flex-column justify-content-center border-approach">
                                        <h3 className="fw-bold mb-2" style={{ color: '#034a27', fontSize: '1.4rem' }}>
                                            {item.title}
                                        </h3>
                                        <p className="mb-0 text-muted lh-base" style={{ fontSize: '1rem' }}>
                                            {item.desc}
                                        </p>
                                    </div>
                                </div>
                ...
                <div className="d-flex flex-column flex-sm-row gap-3 pt-4">
                    <Link href="/" className="btn fw-bold px-4 py-2 border-0 shadow-sm transition-scale" 
                        style={{ backgroundColor: '#EEF430', borderRadius: '4px', fontSize: '14px' }}>
                        View our Portfolio
                    </Link>
                    <Link href="/solutionservice" className="btn fw-bold px-4 py-2 border-0 shadow-sm transition-scale" 
                        style={{ backgroundColor: '#EEF430', borderRadius: '4px', fontSize: '14px' }}>
                        Work With Us
                    </Link>
                </div>
