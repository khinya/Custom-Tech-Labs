...
export default function BannerPage() {
    return (
        <section 
            className="container-fluid min-vh-100 d-flex flex-column justify-content-center py-5"
            style={{
        ...
        >
            <div className="container px-4 px-md-5">
                <div className="row">
                    <div className="col-12 col-md-7 col-lg-6 d-flex flex-column gap-4 text-center text-md-start">
