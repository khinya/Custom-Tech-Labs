...
export default function BetterBuying() {
    return (
        <section className="container-fluid py-5 d-flex flex-column align-items-center gap-5">
            
            {/* Dark Header Card */}
            <div 
                className="container bg-black text-white p-4 p-sm-5 d-flex flex-column gap-3 rounded-4"
            ...
            >
                ...
                <h4 className="fs-6 fw-normal opacity-75">
