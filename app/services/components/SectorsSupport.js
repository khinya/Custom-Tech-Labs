...
export default function SectorsSupport() {
    return (
        <section className="container-fluid py-5 d-flex flex-column align-items-center gap-4">
            ...
            {/* Header Highlight */}
            <div className="container-fluid d-flex justify-content-center align-items-center py-3" style={{ backgroundColor: '#eef430', maxWidth: '800px' }}>
                <h1 className="fw-bold m-0 text-center" style={{ fontSize: 'calc(1.2rem + 1vw)' }}>
                    Sectors We Support
                </h1>
            </div>

            <h3 className="fs-6 fw-normal text-center px-3">
                From startups to established brands, we’ve created e-commerce systems for
            </h3>
            ...
            {/* Bottom Statement */}
            <h2 className="fs-6 fw-normal text-center px-4 mt-3 mx-auto" style={{ maxWidth: '700px' }}>
                No matter the sector, our mission is consistent: <span className="fw-bold">Turn fragmented online operations into unified, scalable commerce ecosystems.</span>
            </h2>

            {/* Decorative Footer Bar */}
            <div className="w-100 mt-4" style={{ backgroundColor: 'black', height: '35px', borderTop: '14px solid #eef430' }}></div>
