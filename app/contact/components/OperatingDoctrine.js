    ...
    return (
        <section className="container py-5 d-flex flex-column align-items-center gap-4 mt-2">
            ...
            <h1 className="badge rounded-pill px-4 py-2 bg-black fw-bold" 
                style={{ color: '#eef430', fontSize: '1.1rem', whiteSpace: 'normal' }}>
                Our Operating Doctrine
            </h1>

            {/* Subtitle */}
            <h2 className="fw-semibold text-center mb-4 px-2" style={{ fontSize: 'calc(1.3rem + .8vw)' }}>
                        ...
                        {group.items.map((item, itemIdx) => (
                            <div key={itemIdx} className="col-12 col-md-6">
                                <div className="h-100 p-4 shadow-sm border-0 d-flex flex-column justify-content-center bg-white shadow-hover transition-all">
                                    ...
                                    {/* Highlighted Title */}
                                    <div className="mb-2">
                                        <h3 className="d-inline-block px-2 fw-bold" 
                                            style={{ backgroundColor: '#eff430', color: '#034a27', fontSize: '1.4rem' }}>
                                            {item.title}
                                        </h3>
                                    </div>

                                    <p className="mb-0 text-muted lh-relaxed" style={{ fontSize: '1rem' }}>
                                        {item.desc}
                                    </p>
                                </div>
                            </div>
            ...
            <div className="d-flex flex-column flex-sm-row gap-3 pt-4">
                <Link 
                    ...
                    style={{ backgroundColor: '#EEF430', minWidth: '170px', height: '45px', borderRadius: '6px' }}
                >
                    View our Portfolio
                </Link>
                <Link 
