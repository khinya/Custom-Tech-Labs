...
export default function CustomApplicationsImpact() {
    return (
        <section className="container-fluid p-0 py-5 position-relative overflow-hidden" style={{ backgroundColor: '#f3f3f3' }}>
            ...
            <div className="container py-5 mt-4">
                ...
                <div className="d-inline-block px-4 py-3 mb-5" style={{ backgroundColor: '#EEF430' }}>
                    <h1 className="text-black fw-bold mb-0" style={{ fontSize: 'calc(1.4rem + 1.2vw)', lineHeight: '1.2' }}>
                            ...
                            {applicationData.map((item, idx) => (
                                ...
                                >
                                    ...
                                    <div className="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0" 
                                         style={{ backgroundColor: '#EEF430', width: '36px', height: '36px' }}>
                                        <FaCheck className="text-black" size={18} />
                                    </div>
                                    
                                    {/* Text */}
                                    <h2 className="fw-semibold mb-0" style={{ fontSize: 'calc(1rem + 0.3vw)' }}>
                                        {item}
                                    </h2>
                                </div>
                            ))}
                ...
                <div className="mt-5 p-4 p-md-5 rounded-3 d-flex flex-column align-items-center" style={{ backgroundColor: '#d9d9d9' }}>
                    ...
                    <div className="col-12 col-lg-10 bg-black rounded-4 p-4 p-md-5 text-center shadow-lg">
                        <h2 className="text-white fw-bold mb-0" style={{ fontSize: 'calc(1.5rem + 1.5vw)', lineHeight: '1.1' }}>
                    ...
                    <div className="d-flex flex-column flex-sm-row gap-3 mt-3">
                        <Link 
                            ...
                            style={{ backgroundColor: '#EEF430', minWidth: '170px', height: '45px' }}
                        >
                            View our Portfolio
                        </Link>
                        <Link 
